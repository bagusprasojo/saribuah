  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
		...
		<?php $this->load->view("_partials/navigation.php") ?>
			...
			<div class="card-body">
				<form action="<?php echo site_url('laporan/pembayaran_per_periode') ?>" method="post" enctype="multipart/form-data" >
          <div class="form-group">
						<label for="periode">Periode </label>
						<input class="form-control" type="date" name="periode" min="0" value="<?php echo date('Y-m-d')?>"/>
					</div>	
